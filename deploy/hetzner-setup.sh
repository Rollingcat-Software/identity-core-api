#!/usr/bin/env bash
# ============================================================================
# Hetzner VPS Setup Script for Identity Core API
# Target: Ubuntu 24.04 LTS on CX33 (4 vCPU, 8 GB RAM), Nuremberg, Germany
#
# Usage:
#   1. SSH into the Hetzner VPS: ssh -i ~/.ssh/hetzner_ed25519 root@116.203.222.213
#   2. Upload this script and run: chmod +x hetzner-setup.sh && sudo ./hetzner-setup.sh
...
echo "============================================"
echo " Identity Core API - Hetzner VPS Setup"
echo "============================================"
