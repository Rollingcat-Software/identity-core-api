-- V51: Defense-in-depth — forbid hard DELETE on users + tenants at the DB layer.
--
-- Background:
...
BEGIN
    ...
    RAISE EXCEPTION
        ...
        'inside their transaction. See V51 migration.', TG_TABLE_NAME
...
COMMENT ON FUNCTION forbid_hard_delete() IS
    ...
    'unless app.allow_hard_delete=''on'' is SET LOCAL in the current TX. See V51.';
