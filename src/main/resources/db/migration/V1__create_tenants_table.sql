...
-- Comments
COMMENT
ON TABLE tenants IS 'Multi-tenant organizations using the FIVUCSAS platform';
COMMENT
ON COLUMN tenants.subscription_plan IS 'FREE, BASIC, PREMIUM, ENTERPRISE';
COMMENT
ON COLUMN tenants.settings IS 'Tenant-specific configuration settings';
COMMENT
ON COLUMN tenants.metadata IS 'Additional tenant metadata';
...
VALUES ('00000000-0000-0000-0000-000000000000',
        ...
        TRUE,
        999999,
        999999) ON CONFLICT (id) DO NOTHING;
