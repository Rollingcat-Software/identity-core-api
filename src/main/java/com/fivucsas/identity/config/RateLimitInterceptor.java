...
public class RateLimitInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(
        ...
        // NOTE: /auth/mfa/qr-generate is rate-limited at the controller layer
        // via RateLimitService.allowMfaQrGenerate (MFA_QR bucket, 5/10min per IP).
        // Centralizing there avoids double-limiting with two conflicting policies.
