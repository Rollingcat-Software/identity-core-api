...
/**
 * Integration test for V51 — BEFORE DELETE triggers on users + tenants.
 *
 * <p>Background: 2026-04-28 incident — a hard {@code DELETE FROM users}
 * cascaded across ~13 child tables. V51 installs
...
@DisplayName("V51 forbid_hard_delete trigger integration test")
class ForbidHardDeleteTriggerIntegrationTest {

    @Container
    static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("fivucsas_v51_test")
            .withUsername("test")
            .withPassword("test");
