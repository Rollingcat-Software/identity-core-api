...
/**
 * Unit tests for {@link ClientSideVoiceEmbeddingPolicy} — the kill-switch that
 * gates the client-side-embedding VOICE path (audit H3, GPU-less). Mirrors
 * {@link ClientSideEmbeddingPolicyTest}: default-OFF (legacy audio path for every
 * tenant), global master-switch ON, and the per-tenant canary list.
 */
@DisplayName("ClientSideVoiceEmbeddingPolicy")
class ClientSideVoiceEmbeddingPolicyTest {
    ...
    class DefaultOff {
        ...
        private final ClientSideVoiceEmbeddingPolicy policy =
                new ClientSideVoiceEmbeddingPolicy(false, "");
    ...
    class GlobalOn {
        ...
        private final ClientSideVoiceEmbeddingPolicy policy =
                new ClientSideVoiceEmbeddingPolicy(true, "");
    ...
    class Canary {
        ...
        private final ClientSideVoiceEmbeddingPolicy policy =
                new ClientSideVoiceEmbeddingPolicy(false, TENANT_A.toString());
    ...
    void canaryListParsing() {
        ClientSideVoiceEmbeddingPolicy policy = new ClientSideVoiceEmbeddingPolicy(
    ...
    class StringOverload {
        ...
        void globalOnEnablesEverything() {
            ClientSideVoiceEmbeddingPolicy policy = new ClientSideVoiceEmbeddingPolicy(true, "");
        ...
        void defaultOffEverythingFalse() {
            ClientSideVoiceEmbeddingPolicy policy = new ClientSideVoiceEmbeddingPolicy(false, "");
