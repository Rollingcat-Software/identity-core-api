...
If you believe you've found a security vulnerability in identity-core-api — the Spring Boot identity, OAuth2, and MFA service of the FIVUCSAS biometric authentication platform — please report it privately so we can fix it before disclosing publicly.

**Email:** info@fivucsas.com (primary) or rollingcat.help@gmail.com (alternate) — subject prefix: `[SECURITY] identity-core-api`
